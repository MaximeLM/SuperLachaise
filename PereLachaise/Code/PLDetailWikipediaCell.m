...
@implementation PLDetailWikipediaCell
...
{
    NSAssert(monument.codeWikipedia && ![monument.codeWikipedia isEqualToString:@""], nil);
...
{
    NSAssert(personnalite.codeWikipedia && ![personnalite.codeWikipedia isEqualToString:@""], nil);
